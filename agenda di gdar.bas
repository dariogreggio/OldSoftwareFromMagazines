...
110 RESTORE110:FORI=0TO6:READB$(I):NEXT:DATA"ÎOME","ÃOGNOME","ÉNDIRIZZO","ÃITTA'
","ÎO. DI TELEFONO","ÐARTICOLARI","ÎOTE"
117 RESTORE117:FORI=0TO6:READRN(I):NEXT:DATA1,33,65,105,134,154,204
120 COLOR6,1:COLOR5,2
130 PRINT"“
            "CHR$(27)"U":CHAR,23,8,"*  Á Ç Å Î Ä Á   Ô Å Ì Å Æ Ï Î É Ã Á  *
135 CHAR,23,6,"***************************************":CHAR,23,7,"*":CHAR,61,7,
"*
137 CHAR,23,10,"***************************************":CHAR,23,9,"*":CHAR,61,9
,"*
140 CHAR,32,19,"ÃÏÐÙÒÉÇÈÔ  1986  Ç.ÄAR
150 WINDOW30,12,54,17:PRINT
160 FORI=1TO110:FORK=1TO70:NEXT:PRINT"ÃÒÅÁÔÁ ÄÁ ÄÁÒÉÏ ÇÒÅÇÇÉÏ ";:NEXT:SLEEP2
...
207 POKE208,0
210 CHAR,0,24," ÉÎÓÅÒÉÓÃÉ  ÃÁÎÃÅÌÌÁ  ÒÉÃÅÒÃÁ  ÍÏÄÉÆÉÃÁ  ÏÒÄÉÎÁ  ÃÈÉÁÍÁ  ??  ÆÉÎÅ
   ÍÅÍ: 55000 ",1:WINDOW0,0,79,23,1
220 PRINT"ÉNSERISCI L'ORA CORRENTE:":A$="":INPUTA$:IFA$=""THENTI$="120000":EL
SETI$=LEFT$(A$+"000000",6)
230 PRINT"ÉNSERISCI LA DATA CORRENTE:":A$="":INPUTA$:DT$="01011986":MID$(DT$,1
,LEN(A$))=A$:DT$=LEFT$(DT$,2)+"/"+MID$(DT$,3,2)+"/"+RIGHT$(DT$,4)
300 REM MAIN
301 POKE2603,8
302 WINDOW0,0,79,23:G$="":PRINTCHR$(27)"U
305 PRINT"“":DOUNTILG$>CHR$(132)ANDG$<CHR$(142)
310 PRINT"ÁGENDA ÔELEFONICA... ÎESSUNA OPERAZIONE IN CORSO"
320 PRINT"ÓONO LE ORE "LEFT$(TI$,2)+":"+MID$(TI$,3,2)+"."+RIGHT$(TI$,2)" DEL "D
T$" , DOMENICA
330 GETG$:LOOP
340 PRINT"“";:ONASC(G$)-132GOTO1000,2000,3000,4000,5000,6000,7000,8000
500 REM SUBR INPUT
510 T$="":TT=0:FL=TT
520 DO:GETKEYB$:IFB$<>CHR$(13)THENFL=1
530 IFASC(B$)=20ANDTT>0THENTT=TT-1:PRINT" ¤";:T$=LEFT$(T$,LEN(T$)-1)
550 IF(B$<" "ORB$>"!")AND(B$<"Á"ORB$>"Ú")AND(B$<"-"ORB$>"_")AND(B$<"#"ORB$>"+")T
HEN580
560 PRINTB$" ";:T$=T$+B$:TT=TT+1
580 LOOPUNTILASC(B$)=13ORTT=VA%
590 RETURN
1000 REM INSERT
1005 WINDOW0,0,79,24:CHAR,72,24,STR$(FRE(1)),1:WINDOW0,0,79,23,1
1010 PRINTTAB(24)"ÉÎÓÅÒÉÍÅÎÔÏ ÄÉ ÕÎ ÎÕÏÖÏ ÎÏÍÉÎÁÔÉÖÏ":WINDOW1,2,78,23,1
1020 FORI=OPTO300
...
1100 DO:CHAR,5,19,"ÃONFERMI (SI/NO)"+CHR$(143)+"         ":VA%=2:GOSUB500:LO
OPUNTILT$="SI"ORT$="NO":H$=T$:PRINT
1110 IFH$="NO"THENCHAR,5,19,"                                 ":GOTO1025
1120 IFA$(I,0)=""ANDA$(I,1)=""ANDA$(I,4)=""THENCHAR,5,19,"      ÁÔÔÅÎÚÉÏÎÅ:"+CH
R$(143)+" DATI INSUFFICIENTI":SLEEP2:GOTO1025
1125 FORX=0TO6:RECORD#1,I,RN(X):UI$=A$(I,X):GOSUB20:PRINT#1,UI$:NEXT
1130 CHAR,5,19,"< Æ1 > PER INSERIRE UN ALTRO NOMINATIVO"
1140 CHAR,5,20,"< Æ3 > PER PROSEGUIRE"
1150 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
1160 IFA$=CHR$(135)THENOP=I+1:GOTO300:ELSENEXTI:GOTO300
1800 PRINT"“°ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀÀ®":GOTO1810
1805 PRINT"°ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀÀ®"
1810 PRINT"Ý"TAB(77)"Ý"
1812 PRINTCHR$(27)"S";
1818 FORX=0TO6
1820 PRINT"Ý  "B$(X)LEFT$(" .....................",18-LEN(B$(X)))LEFT$(" "+LO$,5
3)TAB(77)"Ý"
1830 PRINT"Ý"TAB(77)"Ý"
1840 NEXTX
1850 PRINT"­ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀ½
1860 RETURN
2000 REM DELETE
2005 WINDOW0,0,79,24:CHAR,72,24,STR$(FRE(1)),1:WINDOW0,0,79,23,1
2010 PRINTTAB(26)"ÃÁÎÃÅÌÌÁÚÉÏÎÅ ÄÉ ÕÎ ÎÏÍÉÎÁÔÉÖÏ":WINDOW0,2,w9,23,1
2020 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI:
...
2110 DO:CHAR,5,19,CHR$(27)+"@ÃONFERMI (SI/NO)"+CHR$(143)+"         ":VA%=2:G
...
2202 FL=1:GOSUB2800
2204 CHAR,5,18,"< Æ1 > PER CANCELLARE":CHAR,5,19,"< Æ3 > PER PROSEGUIRE LA RICER
CA":DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
2206 IFA$=CHR$(135)THENCHAR,5,19,CHR$(27)+"@":ELSEGOTO2240
2210 NEXTR
2220 CHAR,5,19,"ÆÉÎÅ ÄÅÌÌÁ ÒÉÃÅÒÃÁ               "
2225 IFFL=0THENCHAR,5,20,"ÁÔÔÅÎÚÉÏÎÅ: "+CHR$(143)+"ÉL NOMINATIVO NON E' PRESENT
E
2230 SLEEP3:CHAR,5,19,CHR$(27)+"@"+"< Æ1 > PER RIPROVARE":CHAR,5,20,"< Æ3 > PER
PROSEGUIRE
2235 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(135)THEN300
2236 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI:"+CHR$(27)+"@"
...
T
2280 CHAR,5,18,CHR$(27)+"@"+" 1 CANCELLATO(I)":CHAR,5,19,"< Æ1 > PER TERMINARE "
:CHAR,5,20,"< Æ3 > PER CANCELLARE ALTRI
2290 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(133)THEN300:ELSEC
HAR,5,18,CHR$(27)+"@":GOTO2210
2800 PRINT"“°ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀÀ®":GOTO2810
2805 PRINT"°ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀÀ®
2810 PRINT"Ý"TAB(77)"Ý"
2812 PRINTCHR$(27)"S";
2815 FORX=0TO6
2820 PRINT"Ý  "B$(X)LEFT$(" ....................",18-LEN(B$(X)))" "A$(R,X)CHR$(-
32*(POS(0)>22))LEFT$(LO$,53-LEN(A$(R,X)))TAB(77)"Ý"
2830 PRINT"Ý"TAB(77)"Ý"
2840 NEXTX
2850 PRINT"­ÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ
ÀÀÀÀÀÀÀÀ½
2860 RETURN
2999 END
3000 REM SEARCH
3005 WINDOW0,0,79,24:CHAR,72,24,STR$(FRE(1)),1:WINDOW0,0,79,23,1
3010 PRINTTAB(27)"ÒÉÃÅÒÃÁ ÄÉ ÕÎ ÎÏÍÉÎÁÔÉÖÏ":WINDOW5,2,79,23,1
3020 PRINT"< Æ1 > PER RICERCARE ALCUNI NOMINATIVI
3030 PRINT"< Æ2 > PER STAMPARE ALCUNI NOMINATIVI
3040 PRINT"< Æ3 > PER VISUALIZZARE TUTTI I NOMINATIVI
3050 PRINT"< Æ4 > PER STAMPARE TUTTI I NOMINATIVI
3055 PRINT"< Æ5 > PER VISUALIZZARE TUTTI I NOMINATIVI IN ORDINE D'IMMISSIONE
3060 PRINT"< Æ6 > PER STAMPARE TUTTI I NOMINATIVI IN ORDINE D'IMMISSIONE
3062 PRINT"< Æ7 > PER TERMINARE
...
3100 REM
3105 PR=0
3107 PRINT"“":CHAR,5,19,"ÉNSERISCI LA CHIAVE DI RICERCA:
...
3190 DO:CHAR,5,19,CHR$(27)+"@ÃONFERMI (SI/NO)"+CHR$(143)+"         ":VA%=2:G
OSUB500:LOOPUNTILT$="SI"ORT$="NO":H$=T$:PRINT
...
3284 CHAR,5,18,"< Æ1 > PER TERMINARE":CHAR,5,19,"< Æ3 > PER PROSEGUIRE LA RICERC
A":DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
3286 CHAR,5,18,CHR$(27)+"@":IFA$=CHR$(135)THENCHAR,5,19,CHR$(27)+"@":ELSEGOTO300

3290 NEXTR
3300 CHAR,5,19,"ÆÉÎÅ ÄÅÌÌÁ ÒÉÃÅÒÃÁ               "
3305 IFFL=0THENCHAR,5,20,"ÁÔÔÅÎÚÉÏÎÅ: "+CHR$(143)+"ÉL NOMINATIVO NON E' PRESENT
E
3310 SLEEP3:CHAR,5,19,CHR$(27)+"@< Æ1 > PER RIPROVARE":CHAR,5,20,"< Æ3 > PER PRO
SEGUIRE
3315 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(135)THEN300
3316 CHAR,5,19,"ÉNSERISCI LA CHIAVE DI RICERCA:"+CHR$(27)+"@"
3317 R=301:GOSUB2805:GOTO3120
3400 PR=1:GOTO3105
3700 PRINT"“":CHAR,5,18,"< Æ1 > PER AVANZARE":CHAR,5,19,"< Æ3 > PER RETROCEDERE"
:CHAR,5,20,"< Æ5 > PER TERMINARE
3710 Y=1
3720 R=Y:GOSUB2805
...
3760 GOTO3700
3800 PRINT"“":CHAR,5,18,"< Æ1 > PER AVANZARE":CHAR,5,19,"< Æ3 > PER RETROCEDERE"
:CHAR,5,20,"< Æ5 > PER TERMINARE
3810 Y=1
...
4010 PRINTTAB(28)"ÍÏÄÉÆÉÃÈÅ ÁÄ ÕÎ ÎÏÍÉÎÁÔÉÖÏ":WINDOW0,2,79,23,1
4020 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI:
...
4110 DO:CHAR,5,19,CHR$(27)+"@ÃONFERMI (SI/NO)"+CHR$(143)+"         ":VA%=2:G
OSUB500:LOOPUNTILT$="SI"ORT$="NO":H$=T$:PRINT
...
4202 FL=1:GOSUB2800
4204 CHAR,5,18,"< Æ1 > PER MODIFICARE":CHAR,5,19,"< Æ3 > PER PROSEGUIRE LA RICER
CA":DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
4206 CHAR,5,18,CHR$(27)+"@":IFA$=CHR$(135)THENCHAR,5,19,CHR$(27)+"@":ELSEGOTO424
0
4210 NEXTR
4220 CHAR,5,19,"ÆÉÎÅ ÄÅÌÌÁ ÒÉÃÅÒÃÁ               "
4225 IFFL=0THENCHAR,5,20,"ÁÔÔÅÎÚÉÏÎÅ: "+CHR$(143)+"ÉL NOMINATIVO NON E' PRESENT
E
4230 SLEEP3:CHAR,5,19,CHR$(27)+"@"+"< Æ1 > PER RIPROVARE":CHAR,5,20,"< Æ3 > PER
PROSEGUIRE
4235 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(135)THEN300
4236 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI:"+CHR$(27)+"@"
4237 R=301:GOSUB2805:GOTO4040
4240 CHAR,5,18,CHR$(27)+"@< Æ1 > PER ANDARE SU":CHAR,5,19,"< Æ3 > PER ANDARE GIU
":CHAR,5,20,"< Æ5 > PER TERMINARE LE MODIFICHE
4250 Y=0:FORI=0TO6:T$(I)=A$(R,I):TT(I)=LEN(T$(I)):NEXT
4260 CHAR,LEN(T$(Y))+22,Y*2+2,CHR$(0)
4270 DO:GETKEYB$
4280 IFASC(B$)=20ANDTT(Y)>0THENTT(Y)=TT(Y)-1:PRINT" ¤";:T$(Y)=LEFT$(T$(Y),LEN
(T$(Y))-1)
4290 IF(B$<" "ORB$>"!")AND(B$<"Á"ORB$>"Ú")AND(B$<"-"ORB$>"_")AND(B$<"#"ORB$>"+")
THEN4305
4300 PRINTB$" ";:T$(Y)=T$(Y)+B$:TT(Y)=TT(Y)+1
...
XT
4330 CHAR,5,18,CHR$(27)+"@< Æ1 > PER PROSEGUIRE":CHAR,5,19,"< Æ3 > PER MODIFICAR
E ALTRI NOMINATIVI
4340 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(133)THEN300:ELSEG
OTO4000
4999 END
5000 REM SORT
5010 PRINTTAB(32)"ÏÒÄÉÎÁ Ì'ÁÒÃÈÉÖÉÏ":WINDOW5,2,79,23,1
5020 PRINT" Ì'ARCHIVIO PUO' ESSERE ORDINATO SECONDO UNO QUALSIASI
5030 PRINT"DEI 7 CAMPI DISPONIBILI:
5040 FORY=0TO6
5050 PRINTTAB(4)"< Æ"CHR$(Y+49)" >  PER ORDINARE I NOMINATIVI SECONDO IL CAMPO "
B$(Y)
5060 NEXT
5065 PRINT"    < Æ8 >  PER TERMINARE
5070 PRINT"           ÓÃÅÇÌÉ !
5080 DO:GETKEYA$:LOOPUNTILA$>CHR$(132)ANDA$<CHR$(141)
5090 IFA$=CHR$(140)THEN300
5100 X=ASC(A$)-133:CHAR,5,13,"ÓCEGLI !  "+B$(X):POKE2603,8
5103 PRINT:PRINT"ÁTTENDERE ...
5105 TF=TI
...
5170 TT=TI:PRINTUSING"   Ï.Ë. ...  ÔEMPO IMPIEGATO : ##  MINUTI,  ##.#  SECOND
...
5999 END
6000 REM CALL
6010 PRINTTAB(30)"ÃÈÉÁÍÁ ÕÎ ÎÏÍÉÎÁÔÉÖÏ":WINDOW0,2,79,23,1
6020 PRINT"  ÐÒÅÍÉ:
6030 PRINT" < Æ1 >  PER COMPORRE UN NUMERO PRESENTE IN ARCHIVIO
6040 PRINT" < Æ3 >  PER COMPORRE UN NUMERO INSERITO DA TASTIERA
6050 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
6060 IFA$=CHR$(133)THEN6200
6070 PRINT"“"TAB(25)CHR$(142)"ÕÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÉ"
6080 PRINTTAB(25)"Ý"TAB(53)"Ý
6090 PRINTTAB(25)"ÊÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀË"CHR$(14)
6100 PRINT""TAB(20)"ÃÏÍÐÏÎÉ ÉÌ ÎÕÍÅÒÏ ÄÉ ÔÅÌÅÆÏÎÏ ÄÅÓÉÄÅÒÁÔÏ
6110 CHAR,39,4,"><
...
6129 CHAR,2,13,"ÓTO COMPONENDO IL NUMERO "+T$+CHR$(143)
6130 FORY=1TOLEN(T$)
...
6180 CHAR,21,18,"< Æ1 >  PER PROSEGUIRE":CHAR,21,19,"< Æ3 >  PER RIPROVARE LO ST
ESSO NUMERO":CHAR,21,20,"< Æ5 >  PER COMPORRE UN ALTRO NUMERO
6190 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)ORA$=CHR$(137):IFA$=CHR$(133
)THEN300:ELSEIFA$=CHR$(135)THEN6129:ELSEGOTO6070
6200 PRINT"“"
6220 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI SULL'ABBONATO:
...
6310 DO:CHAR,5,19,CHR$(27)+"@ÃONFERMI (SI/NO)"+CHR$(143)+"         ":VA%=2:G
OSUB500:LOOPUNTILT$="SI"ORT$="NO":H$=T$:PRINT
...
6402 FL=1:GOSUB2800
6404 CHAR,5,18,"< Æ1 > PER TELEFONARE":CHAR,5,19,"< Æ3 > PER PROSEGUIRE LA RICER
CA":DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
6406 IFA$=CHR$(135)THENCHAR,5,19,CHR$(27)+"@":ELSEGOTO6440
6410 NEXTR
6420 CHAR,5,19,"ÆÉÎÅ ÄÅÌÌÁ ÒÉÃÅÒÃÁ               "
6425 IFFL=0THENCHAR,5,20,"ÁÔÔÅÎÚÉÏÎÅ: "+CHR$(143)+"ÉL NOMINATIVO NON E' PRESENT
E
6430 SLEEP3:CHAR,5,19,CHR$(27)+"@"+"< Æ1 > PER RIPROVARE":CHAR,5,20,"< Æ3 > PER
PROSEGUIRE
6435 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(135)THEN300
6436 CHAR,5,19,"ÉNSERISCI I DATI CONOSCIUTI SULL'ABBONATO:"+CHR$(27)+"@"
6437 R=301:GOSUB2805:GOTO6240
6440 T$=A$(R,4)
6450 CHAR,2,18,CHR$(27)+"@ ÓTO COMPONENDO IL NUMERO  "+T$+CHR$(143):SLEEP1
6460 FORY=1TOLEN(T$)
...
6520 SLEEP3:CHAR,1,18,CHR$(27)+"@    < Æ1 >  PER PROSEGUIRE":CHAR,5,19,"< Æ3 >
PER RIPROVARE LO STESSO NUMERO"
6530 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135):IFA$=CHR$(133)THEN300:ELSEG
OTO6450
6999 END
7000 REM HELP
7010 PRINTTAB(30)"ÓÅÓÓÉÏÎÅ ÄÉ ÁÉÕÔÏ # 01":WINDOW0,2,79,23,1
7999 END
8000 REM END
8010 PRINTTAB(34)"ÆÉÎÅ ÄÅÌ ÌÁÖÏÒÏ":WINDOW0,2,79,23,1
8020 PRINT"“ÐÒÅÍÉ:
8030 IFSV=0THENPRINTTAB(12)"< Æ1 >  PER SALVARE L'ARCHIVIO"
8040 PRINTTAB(12)"< Æ3 >  PER TERMINARE COSI'
8050 DO:GETKEYA$:LOOPUNTILA$=CHR$(133)ORA$=CHR$(135)
8060 IFA$=CHR$(133)THENGOSUB8800:GOTO8020
8070 PRINT"“ÓEI ÓÉÃÕÒÏ DI VOLER TERMINARE ? (SI/NO)  ";:DO:VA%=2:GOSUB
500:LOOPUNTILT$="SI"ORT$="NO"
8080 IFT$="SI"THENSLEEP2:WINDOW0,0,79,24,1:PRINT"ÍEMORIA LIBERA = "FRE(0)+FRE(1)
"BYTES":PRINT"ÏK":GOSUB21000:DCLOSE#1:DOPEN#1,"ARCH-AGENDA Q.TY",L10:PRINT#1,O
P:DCLOSE#1:END
8090 SV=0:GOTO300
8800 REM SUBR SAVE
...
LOSE#1
8880 PRINT""TAB(30)"ÎOMINATIVI  MEMORIZZATI
8890 SLEEP3:RETURN
8999 END
10000 REM SUBR LOAD
...
10018 FORI=1TOOP-1
10020 PRINT"“ ÌOADING  IN  PROGRESS ... "I
10040 FORK=0TO6:RECORD#1,I,RN(K):INPUT#1,A$(I,K):NEXTK
10060 NEXTI
10100 RETURN
20000 IFER<>30THENPRINT"×ÁÒÎÉÎÇ !        "ERR$(ER)" ERROR IN LINE "EL:RESUMENEX
T
20010 DO:INPUT"“ÓEI ÓÉÃÕÒÏ DI VOLER TERMINARE IL LAVORO ? (SI/NO)";T$:LOOPUNTI
LT$="SI"ORT$="NO"
